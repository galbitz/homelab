...
qm destroy "$vm_id"
qm create "$vm_id" --name "ubuntu-2404-cloudinit-template" --memory 2048 --cores 2 --net0 virtio,bridge=vmbr0
...
qm template "$vm_id"
rm noble-server-cloudimg-amd64.img
echo "Successfully created ubuntu-2404-cloudinit-template"