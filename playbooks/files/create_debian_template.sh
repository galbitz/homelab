...
rm debian-12-genericcloud-amd64.raw
wget https://cloud.debian.org/images/cloud/bookworm/latest/debian-12-genericcloud-amd64.raw
virt-customize -a debian-12-genericcloud-amd64.raw --update
virt-customize -a debian-12-genericcloud-amd64.raw --install qemu-guest-agent

qm destroy 9002
qm create 9002 --name "debian-12-cloudinit-template" --memory 2048 --cores 2 --net0 virtio,bridge=vmbr0
qm importdisk 9002 debian-12-genericcloud-amd64.raw local-lvm
